...
│
├── frontend/
│   ├── Dockerfile               # Python 3.10-slim, chainlit entrypoint
│   ├── requirements.txt         # Chainlit, httpx
│   └── app.py                   # Chat UI: streaming consumer, reasoning steps, references
│
└── Oldfile-template/            # (git-ignored) Archived template files, not part of the app
```
